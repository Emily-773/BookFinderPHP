...
<main class="search-page">
  ...
  <section class="search-hero" aria-labelledby="searchTitle">
    ...
    <p>Search by title, author or subject, then save books to your personal library.</p>
    ...
    <div class="search-bar-wrap">
      ...
      <button id="searchBtn" class="bf-btn bf-btn-primary" type="button">Search</button>
      <button id="darkModeToggle" class="bf-btn bf-btn-outline" type="button" aria-label="Toggle dark mode">🌙 Dark mode</button>
    </div>
  </section>
  ...
  <section class="search-panel" aria-labelledby="filterTitle">
    <div class="panel-heading">
      <div>
        ...
        <h2 id="filterTitle">Filter and Sort Current Results</h2>
        <p>Filters and sorting apply to the current search results only.</p>
      </div>
    </div>

    <div class="filter-grid">
      <div>
        <label for="authorFilter">Filter current results by author</label>
      ...
      <div>
        <label for="subjectFilter">Filter current results by subject</label>
      ...
      <div>
        <label for="sortResults">Sort current results</label>
        <select id="sortResults" aria-label="Sort current book results">
    ...
    <div class="filter-actions">
      <button id="applyFiltersBtn" class="bf-btn bf-btn-primary" type="button">Apply Filters</button>
      <button id="clearFiltersBtn" class="bf-btn bf-btn-outline" type="button">Clear Filters</button>
    </div>
  </section>
  ...
  <section class="search-panel" aria-labelledby="historyTitle">
    ...
    <div id="history" class="history-tags" aria-live="polite"></div>
  </section>
  ...
  <section class="search-panel" aria-labelledby="resultsTitle">
    <div class="panel-heading">
      <div>
        ...
        <p>Start a search to see matching books here.</p>
      </div>
    </div>

    <div id="results" class="row" aria-live="polite" aria-busy="false">
      <p class="empty-results-message">Search for a book title, author or subject to begin.</p>
    </div>
  </section>
